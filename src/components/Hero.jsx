...
function Hero() {
  return (
    // <div className="mt-24 relative border-b-8 rounded-b-[10%] overflow-hidden">
    <div className="mt-24 relative border-b-8 rounded-[10%] overflow-hidden">
      <img src={school_landing} className="h-full brightness-50" />
